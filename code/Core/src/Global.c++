...
void General::handleErrors(int &choice)
{

}

//! To change the input case int Lower (small letters), very important in Searching
void General::lowerCase(string &word) //* changes the orginal value
{
...
void General::printLine(int length , char symbol)
{
    
}

//! to stop the screen till the user click 'Enter' , caller is:  getline  or anything
void General::pause(const string & caller)
{
...
void General::updateNo(const string &caller)
{
...
void General::clearMemoryLeak()
{
    
}

//! to put a text in the miidle of a space
string General::centerText(const string &text , int width)
{
    
}

//* doesn't change the orginal value
string General::UpperCaseFirstLetter(string text)
{
